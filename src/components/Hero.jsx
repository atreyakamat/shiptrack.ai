...
const Hero = () => {
  ...
  return (
    <section className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6 text-center">
      ...
      >
        <div className="waitlister-form" data-waitlist-key="tcoxbkP68Gb3" data-height="194px"></div>
        
        <div className="mt-4 flex items-center justify-center">
          <button 
            type="button" 
            onClick={scrollToWishlist}
            className="text-[#94A3B8] hover:text-[#F8FAFC] transition-colors underline decoration-white/20 underline-offset-4 text-sm"
          >
